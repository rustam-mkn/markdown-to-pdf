...
async function main() {
    const tasks = [
        {
            html: 'source/html/file1_cards.html',
            outputPdf: 'dist/Модуль 4. Урок 4. Гайд-список_ «20+ каналов для сдачи кладовки» (vector).pdf'
        },
        {
            html: 'source/html/file2_cards.html',
            outputPdf: 'dist/Модуль 4. Урок 2. Шаблон. Текст-заготовка для объявления (vector).pdf'
        },
        {
            html: 'source/html/file3_cards.html',
            outputPdf: 'dist/Модуль 4. Урок 3. Гайд. «Настройка объявления на Циан» (vector).pdf'
        },
        {
            html: 'source/html/file4_cards.html',
            outputPdf: 'dist/Модуль 4. Урок 6. Чек-лист «Инструменты удаленного управления кладовкой» (vector).pdf'
        },
        {
    ...
    console.log('\n✓ Все векторные PDF файлы успешно созданы!');
